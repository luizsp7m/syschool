...
<?php 
  if(isset($_POST['pesquisa'])) { 
    ...
    $cmdsql = "SELECT * FROM escolas WHERE lower(nome) LIKE '%$valor%' ORDER BY status desc, codigo"; 
  } else { 
    $cmdsql = "SELECT * FROM escolas ORDER BY status desc, codigo";
  } 
?>
        ...
        <div class="container">
          ...
          <form action="inicio.php" method="POST" class="mb-4">
            <div class="input-group w-50 mx-auto">
              <input type="text" class="form-control" placeholder="Nome da escola" name="pesquisa">
          ...
          <div class="card">
            <div class="card-header text-right">
              <a href="adicionar.php">
                <button class="btn btn-outline-primary">Nova Escola</button>
              </a>
            </div>
            <div class="card-body">
