    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container">
          ...
          <?php
            $codigo = $_GET['codigo'];
            $cmdsql = "SELECT * FROM funcionarios WHERE codigo = $codigo";
            $execsql = mysqli_query($linkmy, $cmdsql);
            $registro = mysqli_fetch_array($execsql);
          ?>
          <form method="POST" action="../../_scripts/funcionarios/alterar.php?codigo=<?= $codigo ?>">
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control" name="data_nascimento" value="<?php echo $registro['data_nascimento'] ?>" required>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-4">
                <label>RG <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="rg" value="<?php echo $registro['rg'] ?>" required maxlength="12" minlength="12">
              </div>
              <div class="form-group col-md-4">
                <label>CPF <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="cpf" value="<?php echo $registro['cpf'] ?>" required maxlength="14" minlength="14">
              </div>
              <div class="form-group col-md-4">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="telefone" value="<?php echo $registro['telefone'] ?>" maxlength="14" minlength="14">
              </div>
              <div class="form-group col-md-4">
                <label>Celular</label>
                <input type="text" class="form-control" name="celular" value="<?php echo $registro['celular'] ?>" maxlength="15" minlength="15">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-8">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <?php if($registro['codigo'] == $_SESSION['codigo_funcionario']) {?>
