...
<?php 
  if(isset($_POST['pesquisa'])) { 
    ...
    $cmdsql = "SELECT * FROM funcionarios WHERE lower(nome) LIKE '%$valor%' ORDER BY status desc, codigo"; 
  } else { 
    $cmdsql = "SELECT * FROM funcionarios ORDER BY status desc, codigo";
  } 
?>
      ...
      <div id="page-content-wrapper">
        ...
        <form action="inicio.php" method="POST" class="mb-4">
          <div class="input-group w-50 mx-auto">
            <input type="text" class="form-control" placeholder="Nome do funcionário" name="pesquisa">
          ...
          <div class="card">
            <div class="card-header text-right">
              <a href="adicionar.php">
                <button class="btn btn-outline-primary">Novo Funcionário</button>
              </a>
            </div>
