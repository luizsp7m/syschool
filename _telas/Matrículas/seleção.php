        ...
        <div class="container">
          <form method="GET" action="inicio.php">
            <div class="form-group row">
              <label class="col-lg-2 col-form-label">Selecione uma escola:</label>
                <div class="col-lg-8">
                  <select name="codigo_escola" class="form-control mb-2">
                    <?php
                      $cmsql = "SELECT * FROM escolas WHERE status = 1 ORDER BY nome";
