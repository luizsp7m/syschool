          ...
          <form method="POST" action="../../_scripts/solicitações/adicionar.php">
            <div class="form-row">
              <div class="form-group col-md-8">
                ...
                <input type="text" onkeypress="return ApenasLetras(event,this);" class="form-control" name="nome" required maxlength="60">
              </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" onkeypress="return ApenasLetras(event,this);" class="form-control" name="nome_mae" required maxlength="60">
              </div>
              <div class="form-group col-md-4">
                <label>CPF da mãe <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="cpf_mae" required maxlength="14" minlength="14">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-4">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
              	<?php
                  $cmdsql = "SELECT * FROM escolas WHERE codigo = $_POST[codigo_escola]";
                  $execsql = mysqli_query($linkmy, $cmdsql);
                  $row = mysqli_fetch_array($execsql);
                ?>
                <label>Opção de escola <span class="text-danger">*</span></label>
                <input type="text" class="form-control" placeholder="<?= $row['nome'] ?>" disabled>
                <input type="hidden" name="codigo_escola" value="<?= $_POST['codigo_escola'] ?>">
              </div>
              <div class="form-group col-md-4">
                <?php
                  $cmdsql = "SELECT * FROM turmas WHERE codigo = $_POST[codigo_turma]";
                  $execsql = mysqli_query($linkmy, $cmdsql);
                  $row = mysqli_fetch_array($execsql);
                ?>
                <label>Turma <span class="text-danger">*</span></label>
                <input type="text" class="form-control" placeholder="<?= $row['num_turma'] ?>" disabled>
                <input type="hidden" name="codigo_turma" value="<?= $_POST['codigo_turma'] ?>">
              </div>
              <div class="form-group col-md-4">
                <label>Período <span class="text-danger">*</span></label>
                <input type="text" class="form-control" value="<?= $_POST['periodo'] ?>" disabled>
