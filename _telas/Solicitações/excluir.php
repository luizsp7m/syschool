    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container text-center">
          <p>Deseja excluir o registro <?= "$_GET[codigo]"; ?>?</p>
          <a class="btn btn-danger w-25" href="seleção.php">
            Não
          </a>
          <a class="btn btn-success w-25" href="../../_scripts/solicitações/excluir.php?codigo=<?= "$_GET[codigo]"; ?>">
            Sim
          </a>
        </div>
      </div>
