    ...
    <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
        ...
        <div class="container text-center">
          <p>Deseja desativar o registro <?= "$_GET[codigo]"; ?>?</p>
          <a class="btn btn-danger w-25" href="inicio.php?codigo_escola=<?= $_SESSION['codigo_escola'] ?>">
            Não
          </a>
          <a class="btn btn-success w-25" href="../../_scripts/turmas/excluir.php?codigo=<?= "$_GET[codigo]"; ?>">
            Sim
          </a>
        </div>
      </div>
